...
import (
	...
	storage "github.com/dailycrypto-me/daily-evm/daily/state/contracts/storage"
...
type Contract struct {
	...
	// Total dly supply = genesis balances + block rewards
...
func (self *Contract) lazy_init() {
	...
	self.Abi, _ = abi.JSON(strings.NewReader(dpos_sol.DailyDposClientMetaData))
...
func (self *Contract) DistributeRewards(rewardsStats *rewards_stats.RewardsStats) *uint256.Int {
	...
	// Aspen hf introduces dynamic yield curve, see https://github.com/dailycrypto-me/TIP/blob/main/TIP-2/TIP-2%20-%20Cap%20DLY's%20Total%20Supply.md
