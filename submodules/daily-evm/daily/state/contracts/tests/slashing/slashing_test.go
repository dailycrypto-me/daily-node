...
import (
	...
	"github.com/dailycrypto-me/daily-evm/crypto/secp256k1"
	...
	slashing_sol "github.com/dailycrypto-me/daily-evm/daily/state/contracts/slashing/solidity"
...
func TestDoubleVotingSameVotesHashes(t *testing.T) {
	tc, test := test_utils.Init_test(slashing.ContractAddress(), slashing_sol.DailySlashingClientMetaData, t, DefaultChainCfg)
	defer test.End()
...
func TestDoubleVotingExistingProof(t *testing.T) {
	...
	_, test := test_utils.Init_test(slashing.ContractAddress(), slashing_sol.DailySlashingClientMetaData, t, cfg)
	defer test.End()
...
func TestDoubleVotingInvalidPeriodRoundStep(t *testing.T) {
	_, test := test_utils.Init_test(slashing.ContractAddress(), slashing_sol.DailySlashingClientMetaData, t, DefaultChainCfg)
	defer test.End()
...
func TestGetJailBlock(t *testing.T) {
	...
	tc, test := test_utils.Init_test(slashing.ContractAddress(), slashing_sol.DailySlashingClientMetaData, t, cfg)
	defer test.End()
...
func TestMakeLogsCheckTopics(t *testing.T) {
	...
	Abi, _ := abi.JSON(strings.NewReader(slashing_sol.DailySlashingClientMetaData))
