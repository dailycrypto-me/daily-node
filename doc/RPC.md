...
Daily protocol supports all Ethereum methods described on [this page](https://ethereum.org/en/developers/docs/apis/json-rpc/) except:
...
### daily_getScheduleBlockByPeriod
...
```json
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"daily_pbftBlockHashByPeriod","params":["0x1D533B"],"id":1}'
...
```json
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"daily_getPillarBlockData","params":[100, true],"id":1}'
