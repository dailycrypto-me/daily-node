...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "daily-boot-node.fullname" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "daily-consensus-node.fullname" -}}
...
If release name contains chart name it will be used as a full name.
*/}}
{{- define "daily-node.graphQlWsName" -}}
...
{{- define "daily-node.kubeVersion" -}}
  {{- default .Capabilities.KubeVersion.Version .Values.kubeVersionOverride -}}
{{- end -}}

{{/* Get Ingress API Version */}}
{{- define "daily-node.ingress.apiVersion" -}}
  {{- if and (.Capabilities.APIVersions.Has "networking.k8s.io/v1") (semverCompare ">= 1.19-0" (include "daily-node.kubeVersion" .)) -}}
...
{{- define "daily-node.ingress.isStable" -}}
  {{- eq (include "daily-node.ingress.apiVersion" .) "networking.k8s.io/v1" -}}
{{- end -}}

{{/* Check Ingress supports pathType */}}
{{/* pathType was added to networking.k8s.io/v1beta1 in Kubernetes 1.18 */}}
{{- define "daily-node.ingress.supportsPathType" -}}
  {{- or (eq (include "daily-node.ingress.isStable" .) "true") (and (eq (include "daily-node.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18-0" (include "daily-node.kubeVersion" .))) -}}
{{- end -}}