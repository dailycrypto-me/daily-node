...
#define HAS_RLP_FIELDS                              \
  void rlp(::daily::util::RLPDecoderRef encoding); \
  void rlp(::daily::util::RLPEncoderRef encoding) const;

#define RLP_FIELDS_DEFINE(_class_, ...)                                                                           \
  void _class_::rlp(::daily::util::RLPDecoderRef encoding) { ::daily::util::rlp_tuple(encoding, __VA_ARGS__); } \
  void _class_::rlp(::daily::util::RLPEncoderRef encoding) const { ::daily::util::rlp_tuple(encoding, __VA_ARGS__); }

#define RLP_FIELDS_DEFINE_INPLACE(...)                                                                   \
  void rlp(::daily::util::RLPDecoderRef encoding) { ::daily::util::rlp_tuple(encoding, __VA_ARGS__); } \
  void rlp(::daily::util::RLPEncoderRef encoding) const { ::daily::util::rlp_tuple(encoding, __VA_ARGS__); }
