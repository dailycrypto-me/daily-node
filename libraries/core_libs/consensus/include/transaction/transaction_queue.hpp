...
class TransactionQueue {
 ...
 private:
   ...
   * @return true if removed
   */
  std::unordered_map<daily::trx_hash_t, std::pair<uint64_t, daily::SharedTransaction>>::iterator removeTransaction(
      std::unordered_map<daily::trx_hash_t, std::pair<uint64_t, daily::SharedTransaction>>::iterator transaction);
