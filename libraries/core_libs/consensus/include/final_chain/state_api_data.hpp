...
struct DailyEVMError : std::runtime_error {
  std::string const type;
  DailyEVMError(std::string&& type, const std::string& msg);
};

struct ErrFutureBlock : DailyEVMError {
  using DailyEVMError::DailyEVMError;
};
