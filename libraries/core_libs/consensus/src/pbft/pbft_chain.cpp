...
bool PbftChain::findPbftBlockInChain(daily::blk_hash_t const& pbft_block_hash) {
  return db_->pbftBlockInDb(pbft_block_hash);
}

PbftBlock PbftChain::getPbftBlockInChain(const daily::blk_hash_t& pbft_block_hash) {
