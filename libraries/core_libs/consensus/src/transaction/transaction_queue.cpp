...
std::unordered_map<daily::trx_hash_t, std::pair<uint64_t, daily::SharedTransaction>>::iterator
TransactionQueue::removeTransaction(
    std::unordered_map<daily::trx_hash_t, std::pair<uint64_t, daily::SharedTransaction>>::iterator it) {
