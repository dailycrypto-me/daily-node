...
#undef COLUMN_W_COMP
 ...
 public:
  ...
  void addPbftHeadToBatch(daily::blk_hash_t const& head_hash, std::string const& head_str, Batch& write_batch);
  ...
  // period_pbft_block
  void addPbftBlockPeriodToBatch(PbftPeriod period, daily::blk_hash_t const& pbft_block_hash, Batch& write_batch);
  std::pair<bool, PbftPeriod> getPeriodFromPbftHash(daily::blk_hash_t const& pbft_block_hash);
  // dag_block_period
