...
#ifndef JSONRPC_CPP_STUB_DAILY_NET_TESTFACE_H_
#define JSONRPC_CPP_STUB_DAILY_NET_TESTFACE_H_
 ...
 public:
  TestFace() {
    this->bindAndAddMethod(jsonrpc::Procedure("get_sortition_change", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                           ...
                           &daily::net::TestFace::get_sortition_changeI);
...
#endif  // JSONRPC_CPP_STUB_DAILY_NET_TESTFACE_H_
