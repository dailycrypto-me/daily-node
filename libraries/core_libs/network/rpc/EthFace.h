...
#ifndef JSONRPC_CPP_STUB_DAILY_NET_ETHFACE_H_
#define JSONRPC_CPP_STUB_DAILY_NET_ETHFACE_H_
 ...
 public:
  EthFace() {
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBalance", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,
                           ...
                           &daily::net::EthFace::eth_getBalanceI);
    this->bindAndAddMethod(
    ...
    this->bindAndAddMethod(
        ...
        &daily::net::EthFace::eth_getTransactionCountI);
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBlockTransactionCountByHash", jsonrpc::PARAMS_BY_POSITION,
                           ...
                           &daily::net::EthFace::eth_getBlockTransactionCountByHashI);
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBlockByHash", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                           ...
                           &daily::net::EthFace::eth_getBlockByHashI);
    ...
    this->bindAndAddMethod(
        ...
        &daily::net::EthFace::eth_getTransactionByBlockHashAndIndexI);
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBlockReceipts", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                           ...
                           &daily::net::EthFace::eth_getBlockReceiptsI);
  }
...
#endif  // JSONRPC_CPP_STUB_DAILY_NET_ETHFACE_H_
