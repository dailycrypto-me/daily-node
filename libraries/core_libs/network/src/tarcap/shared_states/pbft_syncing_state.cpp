...
std::shared_ptr<DailyPeer> PbftSyncingState::syncingPeer() const {
  std::shared_lock lock(peer_mutex_);
  return peer_;
}

std::shared_ptr<DailyPeer> PbftSyncingState::lastSyncingPeer() const {
  std::shared_lock lock(peer_mutex_);
...
bool PbftSyncingState::setPbftSyncing(bool syncing, PbftPeriod current_period,
                                      std::shared_ptr<DailyPeer> peer /*=nullptr*/) {
