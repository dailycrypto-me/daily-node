...
void IVotePacketHandler::sendPbftVote(const std::shared_ptr<DailyPeer> &peer, const std::shared_ptr<PbftVote> &vote,
...
void IVotePacketHandler::sendPbftVotesBundle(const std::shared_ptr<DailyPeer> &peer,
