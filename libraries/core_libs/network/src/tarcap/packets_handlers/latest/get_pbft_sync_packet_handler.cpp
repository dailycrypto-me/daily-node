...
void GetPbftSyncPacketHandler::process(GetPbftSyncPacket &&packet, const std::shared_ptr<DailyPeer> &peer) {
...
void GetPbftSyncPacketHandler::sendPbftBlocks(const std::shared_ptr<DailyPeer> &peer, PbftPeriod from_period,
