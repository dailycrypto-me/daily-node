...
TransactionPacketHandler::transactionsToSendToPeer(std::shared_ptr<DailyPeer> peer,
...
void TransactionPacketHandler::sendTransactions(std::shared_ptr<DailyPeer> peer,
