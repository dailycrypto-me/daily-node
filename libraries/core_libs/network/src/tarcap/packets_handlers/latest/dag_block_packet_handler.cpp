...
void DagBlockPacketHandler::process(DagBlockPacket &&packet, const std::shared_ptr<DailyPeer> &peer) {
...
void DagBlockPacketHandler::sendBlockWithTransactions(const std::shared_ptr<DailyPeer> &peer,
