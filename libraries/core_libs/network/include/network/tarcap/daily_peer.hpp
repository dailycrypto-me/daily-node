...
class DailyPeer : public boost::noncopyable {
 public:
  DailyPeer();
  DailyPeer(const dev::p2p::NodeID& id, size_t transaction_pool_size, std::string address);
 ...
 private:
  ...
  // Packets stats for packets sent by *this DailyPeer
