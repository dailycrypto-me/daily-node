...
class PbftSyncingState {
 public:
   ...
   */
  bool setPbftSyncing(bool syncing, PbftPeriod current_period = 0, std::shared_ptr<DailyPeer> peer = nullptr);
   ...
   */
  std::shared_ptr<DailyPeer> syncingPeer() const;

  /**
   * @return last syncing peer, node might not be actively syncing from this peer anymore
   */
  std::shared_ptr<DailyPeer> lastSyncingPeer() const;
