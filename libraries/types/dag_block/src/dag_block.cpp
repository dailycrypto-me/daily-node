...
void DagBlock::rlp(::daily::util::RLPDecoderRef encoding) { *this = DagBlock(encoding.value); }

void DagBlock::rlp(::daily::util::RLPEncoderRef encoding) const { encoding.appendRaw(rlp(true)); }
