...
void PeriodData::rlp(::daily::util::RLPDecoderRef encoding) { *this = PeriodData(encoding.value); }

void PeriodData::rlp(::daily::util::RLPEncoderRef encoding) const { encoding.appendRaw(rlp()); }
