...
void PbftBlock::rlp(::daily::util::RLPDecoderRef encoding) { *this = PbftBlock(encoding.value); }

void PbftBlock::rlp(::daily::util::RLPEncoderRef encoding) const { encoding.appendRaw(rlp(true)); }
