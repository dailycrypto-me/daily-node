...
void OptimizedPbftVotesBundle::rlp(::daily::util::RLPDecoderRef encoding) {
  votes = decodePbftVotesBundleRlp(encoding.value);
}
void OptimizedPbftVotesBundle::rlp(::daily::util::RLPEncoderRef encoding) const {
...
void OptimizedPillarVotesBundle::rlp(::daily::util::RLPDecoderRef encoding) {
  pillar_votes = decodePillarVotesBundleRlp(encoding.value);
}
void OptimizedPillarVotesBundle::rlp(::daily::util::RLPEncoderRef encoding) const {
