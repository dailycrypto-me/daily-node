...
void PbftVote::rlp(::daily::util::RLPDecoderRef encoding) { *this = PbftVote(encoding.value); }

void PbftVote::rlp(::daily::util::RLPEncoderRef encoding) const { encoding.appendRaw(rlp()); }
