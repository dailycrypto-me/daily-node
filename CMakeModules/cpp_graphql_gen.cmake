...
list(APPEND GRAPHQL_GENERATED_SOURCES
  ...
  ${GRAPHQL_GEN_DIR}/DailySchema.cpp
...
add_custom_command(
  ...
  COMMAND cppgraphqlgen::schemagen --schema="${CMAKE_CURRENT_SOURCE_DIR}/network/graphql/schema/schema.daily.graphql" --prefix="Daily" --namespace="daily"
  WORKING_DIRECTORY ${GRAPHQL_GEN_DIR}
  COMMENT "Regenerating DailySchema files"
  DEPENDS ${GRAPHQL_GEN_DIR}/../schema/schema.daily.graphql
)
