...
set(daily_LINT_LEVEL "OFF" CACHE STRING "Lint level during daily build (FULL, HIGH, LOW, OFF)")
...
elseif (VERSION LESS 3.6)
    ...
    if ("${daily_LINT_LEVEL}" STREQUAL "FULL")
        message(STATUS "Linting level set to: FULL")
        set(CLANG_TIDY_CHECKS "-checks='*'")
    elseif ("${daily_LINT_LEVEL}" STREQUAL "HIGH")
    ...
    elseif ("${daily_LINT_LEVEL}" STREQUAL "LOW")
